...
class RhythmDoctorGame(Game):
    ...
    def bosses(self) -> List[str]:
        return [
            ...
            "6-X: Boss Fight",
            "7-X: Miracle Defibrillator",
            "7-X2: Miracle Defibrillator (Cole's Song)",
        ]
